...
public final class PersonWarehouse implements Iterable<Person> {
    ...
    public List<String> getNames() {
        ...
        people.forEach(person -> listOfNames.add(person.getName()));
        return listOfNames;
    }
    ...
    public Stream<Person> getUniquelyNamedPeople() {
        Set<String> uniqueNames = new HashSet<>(people.size());
        return people.stream().filter(person -> uniqueNames.add(person.getName()));
    }
